...
import { Plus, Eye, Edit, LogOut, Users } from "lucide-react";
...
export default function AdminPanel() {
  ...
  useEffect(() => {
    ...
    if (user && user.role !== "admin") {
      console.log("Redirecting to / due to non-admin role");
      router.replace("/");
    }
  }, [user, router]);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Manage users, auctions, and platform statistics
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6 flex flex-col items-center justify-center h-full">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Add User</h3>
              <p className="text-gray-600 dark:text-gray-400 text-center mb-4">
                Create and manage new user accounts for the platform.
              </p>
              <Button
                onClick={() => handleNavigate("/admin-panel/add-user")}
          ...
          <Card>
            <CardContent className="p-6 flex flex-col items-center justify-center h-full">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Manage Auctions</h3>
              <p className="text-gray-600 dark:text-gray-400 text-center mb-4">
                View, edit, and oversee all auction listings.
              </p>
              <Button
                onClick={() => handleNavigate("/admin-panel/manage-auctions")}
                className="bg-corporate-600 hover:bg-corporate-700 text-white"
              >
          ...
          <Card>
            <CardContent className="p-6 flex flex-col items-center justify-center h-full">
              <div className="w-16 h-16 bg-corporate-100 dark:bg-corporate-900/30 rounded-full flex items-center justify-center mb-4">
                <Users className="w-8 h-8 text-corporate-600 dark:text-corporate-400" />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Manage Users</h3>
              <p className="text-gray-600 dark:text-gray-400 text-center mb-4">
                Manage and oversee all user accounts on the platform.
              </p>
              <Button
                onClick={() => handleNavigate("/admin-panel/manage-users")}
                className="bg-corporate-600 hover:bg-corporate-700 text-white"
              >
